...
const STATS = [
  {
    ...
    value: 25,
    suffix: "+",
    gradient: "from-blue-500 via-blue-500 to-indigo-600",
...
const INFO_ROWS = [
  {
    ...
    label: "Every Wednesday at lunch",
    sub: "Weekly meetings",
    color: "#10b981",
  },
  {
...
export default function Home() {
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(150deg,#e0effe 0%,#f0f7ff 35%,#f4fdf6 70%,#e8faf0 100%)",
      }}
    >
      {/* Dot grid texture */}
      <div
      ...
      <Tabs defaultValue="overview" className="flex flex-col flex-1 z-10 relative">
        ...
        <header
          ...
          style={{
            ...
            boxShadow: "0 1px 40px rgba(15,23,42,0.06)",
          }}
        >
          <div className="max-w-5xl mx-auto px-5 h-16 flex items-center justify-between">
            ...
            <TabsList
              className="h-9 p-0.5 gap-0 rounded-xl"
              style={{
        ...
        <main className="flex-1 w-full max-w-5xl mx-auto px-5 pt-14 pb-20">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-black tracking-tighter leading-none mb-4">
              <span
                style={{
                  background:
                    "linear-gradient(100deg,#2563eb 0%,#06b6d4 50%,#10b981 100%)",
                  WebkitBackgroundClip: "text",
                  WebkitTextFillColor: "transparent",
                }}
              >
          ...
          <TabsContent value="overview" className="mt-0 outline-none">
                ...
                return (
                  ...
                  >
                    <div className="relative">
                      <div
                        className="absolute inset-0 rounded-full blur-xl scale-110 opacity-70"
                        style={{
            ...
            >
              ...
              <motion.div
                variants={FADE_UP}
                className="md:col-span-3 rounded-3xl p-8 flex flex-col justify-between gap-6"
                style={{
              ...
              >
                <div>
                  ...
                  <p className="text-slate-500 leading-relaxed">
                    A student-run club teaching game development through Unity,
                    collaborative projects, and peer learning. Seasoned coder or total
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  >
                    <a
                      href="https://docs.google.com/forms/d/e/1FAIpQLSdZ7ct-635WZNLJ_obGYIBTKvfLGigRHJzwLJUQPCMtf7GCpQ/viewform?usp=dialog"
                      target="_blank"
                  ...
                  >
                    <a
                      href="https://www.instagram.com/lahs_game_dev_club/"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
              ...
              <motion.div variants={FADE_UP} className="md:col-span-2 flex flex-col gap-4">
                {INFO_ROWS.map(({ icon, label, sub, color }) => (
                  <div
                    key={sub}
                    className="flex-1 rounded-3xl p-5 flex items-center gap-4 transition-all duration-200 hover:-translate-y-0.5"
                    style={{
                      background: "rgba(255,255,255,0.7)",
                      backdropFilter: "blur(20px)",
                      border: "1px solid rgba(255,255,255,0.95)",
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                {MEMBERS.map((m, i) => (
                  ...
                  >
                    <div className="relative">
                      <div
                        className="absolute inset-0 rounded-full blur-lg scale-125 opacity-50 group-hover:opacity-80 transition-opacity"
                        style={{
                          background: `linear-gradient(135deg,${m.from}80,${m.to}80)`,
                        }}
                      />
                      <div
                        className="relative w-16 h-16 rounded-full flex items-center justify-center text-white font-black text-xl shadow-lg"
                ...
                >
                  ...
                  <div className="flex items-center gap-3 shrink-0">
                    ...
                    <span className="text-2xl font-black text-slate-800">
                      {liveMembers !== null ? liveMembers : "25+"}{" "}
                      <span className="text-slate-400 text-sm font-semibold">active</span>
                    </span>
                  </div>
                </div>
              </motion.div>
